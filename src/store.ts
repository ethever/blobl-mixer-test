...
export const updateBlobState = (querystate: string | undefined) => {
...
export const useUIStore = create((set) => ({
  ...
  snapX: (lerp: number) =>
    set(
      (state: {
        ...
        currentPageX: any;
        textParallax: any;
        updateTargetX: (arg0: number) => void;
      }) => {
  ...
  next: () =>
    set(
      (state: {
        gotoPage: (arg0: any) => void;
        currentPageUnlimited: number;
      }) => {
